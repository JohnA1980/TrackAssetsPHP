<?php 
	...
	class FrequencyType extends BLGenericRecord 
	{ 
		public static $MONTHLY = 1;
		public static $WEEKLY = 2;
		public static $DAILY = 3;
		public static $FORTNIGHTLY = 4;
		...
		public static function allFrequencyTypes(){
			$found = BLGenericRecord::find("FrequencyType", null);
